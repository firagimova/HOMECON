...
/**
 * this function create a new database on the computer using given path URL
 * 
 */
...
/**
 * this function create all database table for app 
 * 
 */
    ...
    /**
     * this function create new folder for database using given path
     */
