...
public class Admin extends AUser implements IAdmin {
    ...
    /***
     * Four parameter constructor for superclass user
    ...
    /***
     * Delete expense table in the database
     * 
     */
    @Override
...
/***
 * Takes user information and create the new user in database
 * @param name name of new user
 * @param surname surname of new user
 * @param userName username of new user
 * @param password password of new user
 * * @throws An exception that provides information on a database access error or other errors.
 */
    @Override
    ...
    /***
     * takes the new admin password and update in database
     * @param newAdminPass new password of admin
     * 
     */
